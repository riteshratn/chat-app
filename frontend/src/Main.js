...
export const Main = ({ online }) => {
  ...
  const [userInfo, setUserInfo] = useState({
    ...
    photoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTREW6RgVD5WtjRgpruCHhsBMEjqIof6VQBKw&usqp=CAU',
  });
  const handleChecked = () => {
  ...
  useEffect(() => {
    ...
    socket.on('updateUserLists', ({ onlineUsers, offlineUsers }) => {
      ...
      if (
        ...
        console.log(`online: ${filteredOnlineUsers}`);
        console.log(`offline: ${filteredOfflineUsers}`);
            ...
            <div className='flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0'>
              ...
              <div
                ...
                <div className='text-lg font-semibold mt-2'>
                  ...
                  <i
                    onClick={handleEdit}
                    className='bx bx-edit-alt edit_icon'></i>
                </div>
